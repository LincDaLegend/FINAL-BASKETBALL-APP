...
export function renderRules() {
  return `
    ...
    <div class="page-subtitle">Define scoring thresholds per category · The AI uses these alongside your deal history</div>
    ...
    <div class="card-section">
      ...
      <div class="section-subtitle" style="margin-bottom:16px">Balance whether the AI prioritizes high ROI deals vs fast-flipping cards</div>
      ...
      <div style="font-size:12px;color:var(--text-muted);margin-top:8px">
        ROI focus → AI favors high-margin cards even if they take longer to flip.<br/>
        Speed focus → AI favors cards likely to sell in under 3 days.
      </div>
    </div>

    <div class="card-section">
      <div class="section-title" style="margin-bottom:6px">How the AI scores listings</div>
      <div style="font-size:13px;color:var(--text-muted);line-height:1.8">
        <div>1. <strong style="color:var(--text-secondary)">Rule check</strong> — Does this card fit the category's max price and min ROI?</div>
        <div>2. <strong style="color:var(--text-secondary)">ML layer</strong> — Compare estimated ROI + flip speed vs your logged deal history averages.</div>
        <div>3. <strong style="color:var(--text-secondary)">Aesthetic score</strong> — Chrome / prizm / holo / gold variants score higher. Condition from eBay listing signals.</div>
        <div>4. <strong style="color:var(--text-secondary)">Final verdict</strong> — buy now (≥70), consider (45–69), skip (&lt;45).</div>
      </div>
    </div>
  `;
}
