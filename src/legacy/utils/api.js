...
// Placeholder — eBay Marketplace Insights requires special scope approval.
// Always returns null so doSearch falls back to computeMarketFromListings.
export async function fetchSoldMarketValue(_query) {
  return null;
}
